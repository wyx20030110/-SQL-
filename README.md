第一步：探测用友OA系统存在SQL注入
![image](https://github.com/user-attachments/assets/3bde32ec-847b-4eb2-a597-d1b79a5f272d)
...
def title():
    ...
    print('+  \033[36mFile         >>> # 写入自己批量处理的文件 如:IP.txt                            \033[0m')
    print('+------------------------------------------')
...
![image](https://github.com/user-attachments/assets/cadca8f5-e3f6-4c12-8719-8a734a33458c)

![image](https://github.com/user-attachments/assets/3223509b-7267-4087-8587-6f21dda4edd2)
